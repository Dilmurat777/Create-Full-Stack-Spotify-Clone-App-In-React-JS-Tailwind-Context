  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        toast.success('Song Added Successful');
        setName('');
        setDesc('');
        setAlbum('none');
        setImage(false);
    ...
    <form onSubmit={submitHandler} className="flex flex-col items-start gap-8 text-gray-600">
      ...
      <div className="flex flex-col gap-2.5">
        ...
        <input
          ...
          value={name}
          className="bg-transparent outline-blue-400 border border-gray-400 p-2.5 w-[max(40vw,250px)]"
      ...
      <div className="flex flex-col gap-2.5">
        ...
        <select
          ...
          defaultValue={album}
          className="bg-transparent outline-blue-400 border-2 border-gray-400 p-2.5 w-[150px]">
